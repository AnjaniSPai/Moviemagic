...
const movies = [
    ...
    },
    {
        ...
        locations: [
            { city: "ballari", theater: "Radhika Theatre", address: "Ganesh Colony, Ballari" },
            { city: "ballari", theater: "Shiva Theatre", address: "Double Road, Ballari" },
            { city: "ballari", theater: "Miraj Cinemas", address: "Urban Oasis Mall, Ballari" }
        ],
        timings: ["10:30 AM", "2:15 PM", "6:30 PM", "9:45 PM"],
        price: 150,
        poster: "../static/images/puspha.jpeg"
    },
    {
        id: 32,
        name: "RRR",
        description: "A fictional story about two revolutionaries and their journey away from home.",
        languages: ["Kannada", "Telugu", "Tamil"],
        locations: [
            { city: "ballari", theater: "Satyam Theatre", address: "Gandhi Nagar, Ballari" },
            { city: "ballari", theater: "Radhika Theatre", address: "Ganesh Colony, Ballari" }
        ],
        timings: ["11:00 AM", "2:30 PM", "6:00 PM", "9:15 PM"],
        price: 200,
        poster: "../static/images/RRR.jpeg"
    }
];
